...
local Settings = {
  -- SETTINGS START --
  general = {
    ["enabled"]=true,             -- controls whether enemy nameplates start ON
    ...
    ["hbheight"]=6,               -- height of nameplates
                                  -- texture of the healthbar (if a non-default it needs to be put in addon folder)  
    ["texture"]="Interface\\AddOns\\CustomNameplates\\assets\\textures\\default",               
  ...
  nametext = {
    ...
    ["font"]="Interface\\AddOns\\CustomNameplates\\assets\\fonts\\PFDinDisplayPro-Med.ttf",  
    ["point"]="BOTTOM",
    ["anchorpoint"]="TOP",
    ["xoffs"]=0,                  -- horizontal offset (+ moves it right, - left)
    ["yoffs"]=-4                  -- vertical offset (+ moves it up, - moves it down) 
  ...
  leveltext = {
    ...
    ["size"]=10,
                                  -- if non default the font file must be copied in CustomNameplates\Fonts\  
    ["font"]="Interface\\AddOns\\CustomNameplates\\assets\\fonts\\YanoneKaffeesatzRegular.ttf",
    ["point"]="TOPLEFT",
...
local _G = getfenv(0)
_G["CustomNameplatesSettings"] = Settings
